...
- [ ] **SC3: A priority vehicle's projected path causes >1 downstream intersection to pre-clear**
      Test ID: `preemption/tests/test_graph_router.py::test_multi_intersection_preclear`

- [ ] **SC4: A t-test or Mann-Whitney U test on paired wait-time samples rejects H0 at α = 0.05**
